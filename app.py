...
# -------------------------------------------------------
clusters = st.sidebar.number_input('Number of clusters',min_value=2, max_value=8,step=1,value=kl.elbow)
...
palette = sns.color_palette(option_palette,n_colors=clusters)
